...
const regex = /\}\)\)\}\s*<div>\s*<label[^>]*>Right Side Banner/g;

file = file.replace(regex, `              <button type="button" onClick={() => {
          ...
          <div className="pt-4">
            <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Right Side Banner`);
